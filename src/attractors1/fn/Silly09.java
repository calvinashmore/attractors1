 ...
 * @author ashmore
 */
public class Silly09 extends AbstractFn {

  public Silly09(ArrayParams parameters) {
    super(parameters);
  }
  ...
  public Point3d apply(Point3d v) {
    ...
    // sawtooth
    // this one keeps xf at same deriv as x
    double xf = v.getX() % (5*p[0]);
    double yf = v.getY() % (5*p[1]);
    double zf = v.getZ() % (5*p[2]);
